    ...
    switch (url.parse(req.url).pathname) {
        ...
        case "/upload":
            ...
            form.parse(req, function (err, fields, files) {
                ...
                let newpath = './static/' + files.filetoupload.name;
                console.log('./static/' + files.filetoupload.name)
...
let GET_handler = (req, res) => {
    ...
    switch (url_str) {
        case '/connection':
            ...
            query_length = Object.keys(JSON.parse(JSON.stringify(query))).length;
        ...
        case '/parameter':
            ...
            if (url_array.length == 2) {
                //http://localhost:3002/parameter?x=2&y=4
